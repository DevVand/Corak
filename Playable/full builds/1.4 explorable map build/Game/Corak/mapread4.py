...
def mapread (sala):
    ...
    #for i in tiles_deco_group: tiles_base.image.blit(i.image, i.rect)
    #tiles_base.image.blit(tiles_deco.image, (0,0))


    '''
    tiles_base2.image.fill(RED)

    tiles_base2.image.blit(tiles_base.image, (0, 0))
    tiles_base2.image.set_colorkey(RED)

    tiles_base.image.fill(RED)
    tiles_base.image.blit(tiles_base2.image, (0, 0))
    '''
