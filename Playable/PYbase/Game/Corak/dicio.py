...
rules = [False,
        ["_strt",  "_end.", "_hall"], #"_key1", "_key2",
         2, 2]

mapSizeX, mapSizeY = 8, 18
mapSize = [mapSizeX, mapSizeY, rules]



rules = [True,
        ["_strt", "_key1", "_key2", "_end.", "_hall"], #
         4, 4]

mapSizeX, mapSizeY = 12, 12
mapSize = [mapSizeX, mapSizeY, rules]
...
CUSTOM = (102, 101, 111) # background 2
WHITE2 = (210, 210, 210)
CUSTOM2 = (50, 0, 25) # background 1
CUSTOM3 = (20, 10, 10)
KEY = (1, 255, 1)
