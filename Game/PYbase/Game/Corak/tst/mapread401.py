        ...
        if "0" in type:
            ...
            if "D" not in sides: #grass
                for position in tilemapdeco:
                    if "D" in position[0]:
                        ...
                        if temp != 9: self.image.blit(tileset, (0, 0), (position[1][1], position[1][0], 16, 16))
            if "L" not in sides: #wall grass
                temp = random.choice([6])
                if temp != 9: self.image.blit(tileset, (0, 0), (tilemapdeco[temp][1][1], tilemapdeco[temp][1][0], 16, 16))
            ...
            if "U" not in sides and "D" in sides:
                ...
                if temp != 9:
                    ...
                    self.image.blit(tileset, (0, 0), (tilemapdeco[temp][1][1], tilemapdeco[temp][1][0], 16, 32))
        ...
        if "1" in type:
            ...
            for position in tilemap:
                if sides == position[0]:
                    ...
                    self.image.blit(tileset, (0, 0), (position[1][1], position[1][0], 16, 16))
        elif "2" in type:
            tileset = pygame.image.load("../Sprites/tileset.png").convert_alpha()
            for position in tilemap:
