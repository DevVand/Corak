...
#pointerLight = Spriter("spotlight.png", 1, (0, 0))
#playerLight = Spriter("spotlight.png", 1, (0, 0))
...
while True:
    ...
    if play_area:
        ...
        playerLight.update((player1.pos[0]+(size/2), player1.pos[1]+(size/2)))
